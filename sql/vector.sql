...
CREATE OR REPLACE FUNCTION test_neighbours() RETURNS TEXT
    AS 'MODULE_PATHNAME'
    LANGUAGE C STRICT;
...
CREATE OR REPLACE FUNCTION test_latency() RETURNS TEXT
    AS 'MODULE_PATHNAME'
    LANGUAGE C STRICT;

CREATE OR REPLACE FUNCTION test_recall() RETURNS TEXT
    AS 'MODULE_PATHNAME'
    LANGUAGE C STRICT;
